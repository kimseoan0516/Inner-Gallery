...
const EMOTION_CATEGORIES = [
  { label: '가라앉음',         emotions: ['슬픔', '외로움', '그리움', '공허함', '결핍', '상처', '자괴감', '후회', '자책', '절망', '무기력', '지침', '부담감'] },
    ...
    <div className="screen" style={{ background: 'var(--bg)' }}>
      ...
      <div className="screen-scroll" style={{ padding: '20px 20px 52px', display: 'flex', flexDirection: 'column', gap: 22 }}>
        ...
        <div style={{ borderRadius: 6, overflow: 'hidden', background: 'var(--card2)', border: '1px solid var(--line)' }}>
          <img
            src={!artwork_image ? '' :
              (artwork_image.startsWith('http') || artwork_image.startsWith('data:'))
              ? artwork_image
        ...
        <div className="card" style={{ padding: '24px 22px', display: 'flex', gap: 16, alignItems: 'flex-start' }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {derivedEssayTitle && (
              <p style={{ fontSize: 13, color: 'var(--gold2)', lineHeight: 1.65, letterSpacing: 0.2, fontFamily: "'Noto Serif KR', serif", marginTop: 10 }}>
                {derivedEssayTitle}
              </p>
            )}
          </div>
