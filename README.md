...
수천 개의 말로도 지금의 감정 하나를 붙잡지 못할 때가 있습니다.

무엇이 힘든지, 왜 불안한지, 무엇이 공허한지 스스로도 설명하기 어려운 순간이 있습니다. 하지만 어떤 그림 앞에서는 이상하리만큼 마음이 오래 머무릅니다.

어떤 색은 나를 진정시키고, 어떤 풍경은 잊고 있던 기억을 떠오르게 하며, 어떤 여백은 지금의 감정을 다시 바라보게 만듭니다.

**그림은 말보다 먼저 감정에 다가옵니다.**

그래서 많은 미술치료와 예술 감상 프로그램은 작품을 해석하는 것보다, 작품을 매개로 자신의 내면을 들여다보는 경험에 주목합니다. 중요한 것은 작품의 정답을 아는 것이 아니라, 그 작품이 나에게 어떤 감정을 불러일으키는지 알아차리는 것입니다.

**Inner Gallery는 이 지점에서 출발했습니다.**

대부분의 미술 앱은 묻습니다.

> **"이 작품은 무엇인가?"**

하지만 저는 다른 질문을 던지고 싶었습니다.

> **"왜 지금 이 작품에 마음이 머무는가?"**

사람은 자신이 오래 바라보는 색과 형태, 공간에 현재의 마음을 비추곤 합니다. 어떤 작품에 끌리는지, 어떤 장면에서 시선이 멈추는지, 어떤 감정을 기록하는지는 지금의 심리 상태와 무관하지 않습니다.

**Inner Gallery는 작품 정보를 제공하는 데서 끝나지 않습니다.**

사용자가 작품을 촬영하거나 업로드하면, 시스템은 작품을 식별하고 시각적 특징을 분석합니다. 그리고 그 결과를 바탕으로 감상 질문, AI 해설, 마음색 선택, 마음 스케치, 회고문 작성으로 이어지는 하나의 감정 여정을 제공합니다.

사용자는 감상 전후의 감정을 기록하고, 작품이 남긴 흔적을 색과 그림, 문장으로 표현합니다. 그리고 그 순간의 마음은 하나의 전시 티켓 형태로 저장되어 개인만의 감정 아카이브가 됩니다.

이 프로젝트에서 가장 중요하게 생각한 것은 두 가지입니다.

### 1. 감성적인 AI가 근거 없는 해석을 하지 않을 것

예술은 주관적인 경험이지만, AI의 해설은 실제 작품과 시각적 근거 위에 서 있어야 합니다.

Inner Gallery는 작품 식별 결과, 컴퓨터 비전 분석 데이터, 직접 구축한 작품 맥락 데이터베이스를 기반으로 해설을 생성합니다. 보이지 않는 표정이나 의도를 상상하지 않도록 설계하고, 불확실한 시각 주장은 차단했습니다.

### 2. 감상 이후의 감정을 사라지지 않게 기록할 것

좋은 작품은 순간적으로 위로를 주기도 하지만, 그 순간의 감정은 쉽게 흩어집니다.

Inner Gallery는 작품 정보뿐 아니라 감상 전후 감정, 마음색, 감상 질문에 대한 답변, 마음 스케치, AI 회고문까지 하나의 기록으로 저장합니다. 사용자는 자신의 감정 변화를 시간의 흐름 속에서 다시 돌아볼 수 있습니다.

> [!NOTE]
> Inner Gallery는 의료적 치료나 심리 진단을 제공하지 않습니다. 본 프로젝트는 미술치료와 예술 감상 활동에서 영감을 받아, 작품을 통해 자신의 감정을 언어화하고 기록하는 자기 성찰 경험을 제공하는 것을 목표로 합니다.

**결국 Inner Gallery가 만들고 싶은 것은 작품 해설 서비스가 아닙니다.**

**작품을 통해 지금의 나를 이해할 수 있도록 돕는 AI 아트 저널입니다.**

어쩌면 우리는 그림을 이해하려고 미술관에 가는 것이 아니라,

**그림을 통해 자기 자신을 이해하기 위해 그 앞에 서는 것인지도 모릅니다.**
